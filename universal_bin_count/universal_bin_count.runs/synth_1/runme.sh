...
HD_PWD='C:/Users/m_rah/Desktop/Co-design/universal_bin_count/universal_bin_count.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uni8bitBC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uni8bitBC.tcl
