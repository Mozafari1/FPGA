...
HD_PWD='C:/Users/m_rah/Desktop/Co-design/multi_arch/multi_arch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multi_arch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multi_arch.tcl
