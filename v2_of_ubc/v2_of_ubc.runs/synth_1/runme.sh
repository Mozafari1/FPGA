...
HD_PWD='C:/Users/m_rah/Desktop/Co-design/v2_of_ubc/v2_of_ubc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ubc8bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ubc8bit.tcl
