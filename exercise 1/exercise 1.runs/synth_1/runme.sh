...
HD_PWD='C:/Users/m_rah/Desktop/Co-design/exercise 1/exercise 1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ff.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ff.tcl
