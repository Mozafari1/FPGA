...
HD_PWD='C:/Users/m_rah/Desktop/Co-design/m_mod_counter/m_mod_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log m_mod_count.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source m_mod_count.tcl
