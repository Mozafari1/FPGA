...
HD_PWD='C:/Users/m_rah/Desktop/Co-design/edice_v3/edice_v3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mod_m_count.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mod_m_count.tcl
