...
HD_PWD='C:/Users/m_rah/Desktop/SDK/vitisSDK/vitisSDK.runs/designSDK_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log designSDK_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source designSDK_auto_pc_0.tcl
