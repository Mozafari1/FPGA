...
HD_PWD='C:/Users/m_rah/Desktop/SDK/vitisSDK/vitisSDK.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log designSDK_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source designSDK_wrapper.tcl
