...
HD_PWD='C:/Users/m_rah/Desktop/SDK/vitisSDK/vitisSDK.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log designSDK_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source designSDK_wrapper.tcl -notrace
