...
HD_PWD='C:/Users/m_rah/Desktop/SDK/vitisSDK/vitisSDK.runs/designSDK_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log designSDK_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source designSDK_axi_gpio_0_0.tcl
