...
HD_PWD='C:/Users/m_rah/Desktop/Co-design/edice_v2/edice_v2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log edice.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source edice.tcl
