...
HD_PWD='C:/Users/m_rah/Desktop/Co-design/edice_v0/edice_v0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log edice.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source edice.tcl -notrace
