...
HD_PWD='C:/Users/m_rah/Desktop/Co-design/deocder2to4 with en and when en is absand/deocder2to4 with en and when en is absand.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dec2to4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dec2to4.tcl
